...
#ifdef PARALLEL
/**
 * @brief Set the problem definition to optimize the Triangle model using Borg MOEA.
 * 
 * @param problem A reference to the BORG problem object.
 */
...
#pragma omp single
        ...
        // Reading in annual demand projections
#pragma omp single
...
#pragma omp single
        ...
        // Reading in demand to wastewater fractions
#pragma omp single
        {
        ...
        // Reading in demand classes and user classes' fractions
        ...
        // Reading in user classes' water prices
        ...
        // Reading in price surcharges for OWASA
