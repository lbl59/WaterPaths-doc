...
//            infraRank(6, granite_quarry_rank),
    ...
    EvaporationSeries evaporation_owasa(&evap_jordan_lake, streamflow_n_weeks);
 ...
 */
    ...
    Utility watertown((char *) "Watertown", 0, demand_watertown, demand_projection_watertown, demand_n_weeks, watertown_annual_payment,
    ...
    //FIXME: bond etc need to be updated, should chat about demand buffer
    Utility dryville((char *) "Dryville", 1, demand_dryville, demand_projection_dryville, demand_n_weeks, dryville_annual_payment,
    ...
    Utility fallsland((char *) "Fallsland", 2, demand_fallsland, demand_projection_fallsland, demand_n_weeks, fallsland_annual_payment,
